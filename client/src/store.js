...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    [GET_DB_CHANGE](state, data) {
      ...
      data.youtube_current ? state.youtube.current = data.youtube_now : state.youtube.current = null
      ...
      data.spotify_current ? state.spotify.current = data.spotify_now : state.spotify.current = null
